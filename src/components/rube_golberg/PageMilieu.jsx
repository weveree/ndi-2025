...
export default function PageMilieu() {
   ...
   script.onload = () => {
    ...
    const ball2 = Bodies.circle(425, 0, 10, {
     ...
     const checkRemainingBalls = () => {
       ...
       const ballsInCanvas = balls.filter(ball => 
       ...
       if (ballsInCanvas.length === 0 && balls.length > 0) {
         console.log('Toutes les balles sont sorties ! Navigation vers PageFin...');
         window.location.href = '/PageFin';
       }
     };
