...
export default function PageDebut() {
    ...
    useEffect(() => {
        ...
        script.onload = () => {
            ...
            Matter.Events.on(engine, "collisionStart", function (event) {
                event.pairs.forEach(pair => {
                    ...
                    if (
                        ...
                        console.log("La Reparation a touché la plateforme !");
                    ...
                    if (
                        ...
                        console.log("La Argent a touché la plateforme !");
                    ...
                    if (
                        ...
                        console.log("La Eclair a touché la plateforme !");
            ...
            World.add(world, [Reparation, Argent, Eclair, Obstacle1, Obstacle2, Obstacle3, Obstacle4, Obstacle5, Obstacle6, Obstacle7, Obstacle8, Obstacle9, Obstacle10,
                Obstacle11, Obstacle12, Obstacle13, Obstacle14, Obstacle15, Obstacle16, Obstacle17,
                Obstacle20, Obstacle21, Obstacle22, Obstacle23, Obstacle24, Obstacle25, Obstacle26, Obstacle27,
                Obstacle30, Obstacle31, Obstacle32, Obstacle33, Obstacle34, Obstacle35,
                Obstacle40, Obstacle41, Obstacle42, Obstacle43, Obstacle44, Obstacle45,
                Obstacle50, Obstacle51, Obstacle52, Obstacle53,
                sep1, sep2, sep3, sep4,
                pente, pente1, pente2, pente3, pente4, pente5, pente6, pente7,
                roue1, constraint1,
                fin,

                sol, sol2, murGauche, murDroit]);
